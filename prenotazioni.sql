...
CREATE TABLE `utente` (
  ...
  `autorita` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
ALTER TABLE `dipendente_dettagli`
  ADD PRIMARY KEY (`id_dipendente`),
  ADD KEY `FK70orwsj1nbq7oyy7tloe3h1it` (`email`);
...
--
ALTER TABLE `utente`
  ADD CONSTRAINT `utente_ibfk_1` FOREIGN KEY (`email`) REFERENCES `dipendente_dettagli` (`email`);
COMMIT;
